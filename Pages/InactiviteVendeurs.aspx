...
<asp:Content ID="Content3" ContentPlaceHolderID="contentBody" Runat="Server">
    ...
    <div class="container">
        <div class="jumbotron">
                <h1>Vendeurs inactifs</h1> 
                <p>Appuyez sur le (X) rouge pour désactiver le compte vendeur</p> 
        </div>
        ...
        <div id="divMessage" class="alert alert-warning" visible="false" runat="server">
          <strong>Il n'y a aucun vendeur inactif depuis la période sélectionné</strong>
        </div>
    </div>
