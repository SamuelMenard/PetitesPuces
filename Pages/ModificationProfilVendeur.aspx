...
<div class="container-fluid containerForm">
   ...
   <div class="form-group">
      <label for="tbNomEntreprise">Nom de l'entreprise</label>
      <asp:TextBox ID="tbNomEntreprise" runat="server" CssClass="form-control" MaxLength="50" />
   ...
   <div class="form-group">
      <label for="tbPoidsMaxLivraison">Poids de livraison maximum</label>
      <div class="input-group">
         <asp:TextBox ID="tbPoidsMaxLivraison" runat="server" TextMode="Number" CssClass="form-control" />
         <span class="input-group-addon">lbs</span>
      </div>
      <asp:Label ID="errPoidsMaxLivraison" runat="server" CssClass="text-danger hidden" />
   </div>
   <div class="form-group">
      <label for="tbLivraisonGratuite">Montant pour avoir la livraison gratuite</label>
      <div class="input-group">
         <asp:TextBox ID="tbLivraisonGratuite" runat="server" TextMode="Number" step="0.01" CssClass="form-control" />
