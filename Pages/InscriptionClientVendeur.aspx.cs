...
public partial class Pages_InscriptionClientVendeur : System.Web.UI.Page
{
    ...
    protected bool validerPage()
    {
        ...
        return (cbCoordonnees.Checked ? ((tbNom.Text == "" || exprNomOuPrenom.IsMatch(tbNom.Text)) &&
               ...
               (tbTelephone2.Text == "" || exprTelephone.IsMatch(tbTelephone2.Text))) : true) &&
